...
// import {  addDocument, bikeDetails, bikeReview, editUser,filterBikes, googleAuth, loadBikes, loadEditUser, loadHomePage, logoutUser, resendOTP, setNewPassword, userBookingList, userProfile, verifyEmailForgotPass, verifyForgPasOTP, verifyLogin, verifyOTP, verifyUser, wallet } from '../Controller/UserController.js'
...
import multer from 'multer';
import { 
    addDocument, bikeDetails, bikeReview, editUser, filterBikes, googleAuth, loadBikes, loadEditUser, loadHomePage, logoutUser, resendOTP, setNewPassword, userBookingList, userProfile, verifyEmailForgotPass, verifyForgPasOTP, verifyLogin, verifyOTP, verifyUser, wallet 
...
// Routes requiring authentication and/or user status checks
user_router.get('/userprofile', userAuth, is_blocked, userProfile);
user_router.post('/add-document', uploadprdt.array('document'), addDocument);
user_router.get('/load-edituser', userAuth, loadEditUser);
user_router.post('/edituser', userAuth, editUser);
